...
public class UserInfoRepository {
    ...
    public Uni<UserInfoModel> addUserInfo(
        UUID userId,
        String userSurname,
        String userName,
        ...
        return databaseController
            ...
            .onItem()
            .transform(iterator -> iterator.hasNext() ? UserInfoModel.from(iterator.next()) : null);
    }

    public Uni<UserInfoModel> getUserInfo(UUID userId, PgPool client) {
        HashMap<String, ParameterInput> parameters = new HashMap<>();
        parameters.put("ACCOUNT_UUID", new ParameterInput("ACCOUNT_UUID", userId.toString()));
        return databaseController
