...
public class SRP {
    ...
    public static BigInteger n = new BigInteger(
            ...
            16);
    public static BigInteger g = new BigInteger("USERS_MODEL.xml");
    ...
    public static String getKeyServer(
            BigInteger serverPublicKey, BigInteger userPublicKey, BigInteger verifier, BigInteger serverPrivateKey) {
        return H(userPublicKey
                .multiply(verifier.modPow(
                        new BigInteger(H(serverPublicKey.toString(16) + userPublicKey.toString(16)), 16), n))
                .modPow(serverPrivateKey, n)
                .toString(16));
    }

    public static String getKeyClients(
            BigInteger serverPublicKey, BigInteger userPublicKey, BigInteger passwordHash, BigInteger userPrivateKey) {
        return H(serverPublicKey
                .subtract(k.multiply(g.modPow(passwordHash, n)))
                .modPow(
                        userPrivateKey.add(
                                new BigInteger(H(serverPublicKey.toString(16) + userPublicKey.toString(16)), 16)
                                        .multiply(passwordHash)),
                        n)
                .toString(16));
    }
