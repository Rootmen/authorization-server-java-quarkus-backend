...
public class UserAccountModel {
    ...
    public Uni<UserAccount> addUserAccount(
            String accountName, String userMail, String passwordVerifier, String salt, PgPool client) {
        HashMap<String, ParameterInput> parameters = new HashMap<>();
        parameters.put("ACCOUNT_NAME", new ParameterInput("ACCOUNT_NAME", accountName));
    ...
    public Uni<UserAccount> updateUserAccount(UserAccount userAccount, PgPool client) {
        ...
        parameters.put(
                "ACCOUNT_UUID",
                new ParameterInput("ACCOUNT_NAME", userAccount.getAccountId().toString()));
        ...
        parameters.put(
                ...
                new ParameterInput("ACCOUNT_PASSWORD_VERIFIER", userAccount.getAccountPasswordVerifier()));
        parameters.put("ACCOUNT_SALT", new ParameterInput("ACCOUNT_SALT", userAccount.getAccountSalt()));
        parameters.put(
                "ACCOUNT_PASSWORD_RESET_INTERVAL",
                new ParameterInput(
                        "ACCOUNT_PASSWORD_RESET_INTERVAL",
                        Integer.toString(userAccount.getAccountPasswordResetInterval())));
        return databaseController
