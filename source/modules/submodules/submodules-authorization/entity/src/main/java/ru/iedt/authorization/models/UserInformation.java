...
public class UserInformation {
    ...
    public UserInformation(UUID account_id, String user_surname, String user_name, String user_patronymic, LocalDate user_date_of_birth, int user_personal_number, int user_structure, UUID user_current_post, String user_phone, String user_office) {
