...
public class Session {
    ...
    public Session(String session_id, BigInteger session_key, LocalDateTime session_start, UUID session_account_id, BigInteger session_server_private_key, BigInteger session_server_public_key, BigInteger session_account_public_key, BigInteger session_scrambler, BigInteger session_authorization_key, String session_signature) {
